...
class NotesListViewController: UIViewController, UITableViewDataSource {
    ...
    fileprivate func setUpFetchedResultsController() {
        ...
        fetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: dataControler.viewContext, sectionNameKeyPath: nil, cacheName: nil)
